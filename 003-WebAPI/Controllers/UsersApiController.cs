...
namespace ImdbServerCore
{
    ...
    public class UsersApiController : ControllerBase
    {
		...
		public UsersApiController(IUsersRepository _usersRepository, IHostingEnvironment environment)
		{
		...
		//		string fileName = Guid.NewGuid().ToString();
		//		string filePath = environment.WebRootPath + "/images/users/" + fileName + "." + extension;
		//		using (FileStream binaryFileStream = new FileStream(filePath, FileMode.Create, FileAccess.ReadWrite))
		//		{
		//			binaryFileStream.Write(bytes, 0, bytes.Length);
